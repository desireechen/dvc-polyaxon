...
def run_experiment(params, train_data_path, test_data_path):
    ...
    try:
        ...
        X_train, y_train = dpl.transform_train_data(train_data_path) # transform your train data using the train_data_path as a parameter
        ...
        experiment.log_metrics(mse=test_mse)
